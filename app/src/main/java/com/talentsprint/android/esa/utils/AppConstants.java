...
public class AppConstants {
    ...
    public static final String MY_EXAMS = "myExams";
    public static final String QUIZ_INSTRUCTIONS = "quizInstructions";
    public static final String QUIZ_QUESTIONS = "quizQuestions";
    public static final String QUIZ_RESULT = "quizResult";
    public static final String STRATERGY = "stratergy";
