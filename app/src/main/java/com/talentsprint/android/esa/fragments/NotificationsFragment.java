 ...
 */
public class NotificationsFragment extends Fragment implements View.OnClickListener, CalenderInterface {
    ...
    public void selectedDate(long date) {
        ...
        if (dateIndexingMap.containsKey(selectedDate)) {
            ...
            Toast.makeText(getActivity(), "No notifications found for the selected date", Toast.LENGTH_SHORT).show();
        }
