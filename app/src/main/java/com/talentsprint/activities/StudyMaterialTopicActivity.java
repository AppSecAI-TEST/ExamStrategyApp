...
public class StudyMaterialTopicActivity extends Activity {
            ...
            public MyViewHolder(View view) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent navigate = new Intent(StudyMaterialTopicActivity.this, StudyMaterialSubtopicActivity.class);
